  ...
  return (
    <div className="max-w-2xl mx-auto space-y-8 animate-in slide-in-from-bottom-4 duration-500">
      <div className="text-center">
        <h2 className="text-3xl font-bold text-white mb-2">Micro-Training Drill</h2>
        <p className="text-slate-400">Stay sharp. Answer correctly to earn XP.</p>
      </div>

      <div className="bg-slate-800/50 p-8 rounded-2xl border border-slate-700 backdrop-blur-sm min-h-[400px] flex flex-col justify-center">
        {loading ? (
          ...
          <div>
            ...
            <div className="space-y-3">
              {question.options.map((opt, idx) => {
                ...
                if (!isAnswered) {
                  btnClass += "border-slate-700 bg-slate-800 hover:border-indigo-500 hover:bg-slate-700 text-slate-200";
                } else {
            ...
            {isAnswered && (
              <div className="mt-8 pt-6 border-t border-slate-700 animate-in fade-in slide-in-from-top-2">
                ...
                <button 
                  ...
                  className="flex items-center gap-2 px-6 py-2 bg-indigo-600 hover:bg-indigo-500 text-white rounded-lg font-bold transition-colors ml-auto"
                >
